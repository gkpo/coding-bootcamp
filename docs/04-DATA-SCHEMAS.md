...
interface CodeBlock { lang: 'js' | 'ts'; source: string; }
...
interface McqOption { text: string; correct?: true; whyWrong?: string; }
...
interface ParsonsLine { code: string; indent: 0 | 1 | 2 | 3; distractor?: true; }
...
type Exercise =
  | McqExercise | ComplexityExercise | ParsonsExercise
  | SpotBugExercise | BlankExercise | MatchExercise | StepsExercise;
```
