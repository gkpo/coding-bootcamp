...
export const t2Exercises: Exercise[] = [
  ...
  },
  {
    ...
    lines: [
      { code: 'const chosen = [];', indent: 0, swapGroup: 'decls' },
      { code: 'let freeFrom = 0;', indent: 0, swapGroup: 'decls' },
      { code: 'for (const meeting of meetings) {', indent: 0 },
      { code: 'if (meeting.start >= freeFrom) {', indent: 1 },
      { code: 'chosen.push(meeting);', indent: 2, swapGroup: 'take' },
      { code: 'freeFrom = meeting.end;', indent: 2, swapGroup: 'take' },
      { code: '}', indent: 1 },
      { code: '}', indent: 0 },
  ...
  },
  {
    ...
    lines: [
      { code: 'let lo = 0;', indent: 0, swapGroup: 'bounds' },
      { code: 'let hi = s.length - 1;', indent: 0, swapGroup: 'bounds' },
      { code: 'while (lo < hi) {', indent: 0 },
      { code: 'if (s[lo] !== s[hi]) return false;', indent: 1 },
      { code: 'lo++;', indent: 1, swapGroup: 'advance' },
      { code: 'hi--;', indent: 1, swapGroup: 'advance' },
      { code: '}', indent: 0 },
